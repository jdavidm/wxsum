...
- The option prefix allows the user to append a custom prefix to all variables generated by the command. This is especially useful to avoid overwriting variables if the command is run multiple times for different parameters.
